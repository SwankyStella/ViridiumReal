...
public class ViriBlocks {
    ...
    public void preInit() {
        ...
        GameRegistry.registerBlock(baobabLog, baldCypressLogItem.class, "baobab_log");

        blackPineLog = new BaseFullLog().setBlockName("black_pine_log");
        GameRegistry.registerBlock(blackPineLog, baldCypressLogItem.class, "black_pine_log");

        dragonsBloodLog = new BaseFullLog().setBlockName("dragons_blood_log");
        GameRegistry.registerBlock(dragonsBloodLog, baldCypressLogItem.class, "dragons_blood_log");

        royalPalmLog = new BaseFullLog().setBlockName("royal_palm_log");
        GameRegistry.registerBlock(royalPalmLog, baldCypressLogItem.class, "royal_palm_log");

        sierraJuniperLog = new BaseFullLog().setBlockName("sierra_juniper_log");
        GameRegistry.registerBlock(sierraJuniperLog, baldCypressLogItem.class, "sierra_juniper_log");

        sweetgumLog = new BaseFullLog().setBlockName("sweetgum_log");
        GameRegistry.registerBlock(sweetgumLog, baldCypressLogItem.class, "sweetgum_log");

        weepingWillowLog = new BaseFullLog().setBlockName("weeping_willow_log");
        GameRegistry.registerBlock(weepingWillowLog, baldCypressLogItem.class, "weeping_willow_log");
    }
